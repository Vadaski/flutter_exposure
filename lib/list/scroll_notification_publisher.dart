...
class ScrollNotificationPublisher extends InheritedWidget {
  ScrollNotificationPublisher({Key key, Widget child}) : super(key: key, child: child);
  ...
  static StreamController<ScrollNotification> of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<ScrollNotificationPublisher>().scrollNotificationController;
  }
}
